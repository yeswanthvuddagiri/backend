...
exports.RFC8252HTTPServer = exports.getAllInterfaces = void 0;
    ...
    get listeningPort() {
        ...
        if (typeof port !== 'number') {
            const addressesDebugInfo = addresses
                ...
                .join(',');
            // Should never happen
            throw new types_1.MongoDBOIDCError(`Server is listening in inconsistent state: ${addressesDebugInfo}`);
        }
        return port;
    }
    /**
        ...
        try {
            ...
            for (let attempts = 1;; attempts++) {
                ...
                if (urlPort === 0) {
                    ...
                    if (typeof port !== 'number') {
                        // Should never happen
                        throw new types_1.MongoDBOIDCError(`Listening on ${dnsResults[0].address} (family = ${dnsResults[0].family}) did not return a port`);
                    }
                }
                try {
